...
syn keyword vhdlStatement case component configuration
syn keyword vhdlStatement disconnect downto
syn keyword vhdlStatement elsif end entity exit
syn keyword vhdlStatement for function
...
syn keyword vhdlStatement select severity shared
...
syn keyword vhdlStorageClass signal constant variable file
...
" ConstantMacro
syn keyword vhdlConstantMacro all
syn keyword vhdlConstantMacro open
syn keyword vhdlConstantMacro others
syn keyword vhdlConstantMacro null
syn keyword vhdlConstantMacro unaffected
syn keyword vhdlConstantMacro inherit
" array attributes
